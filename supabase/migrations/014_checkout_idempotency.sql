...
revoke all on function public.create_storefront_order_v5(jsonb,jsonb,uuid,text,text,text,text)
  from public,anon,authenticated;
grant execute on function public.create_storefront_order_v5(jsonb,jsonb,uuid,text,text,text,text)
  to service_role;
