...
new Script(`
  ...
  const renderShowcases=()=>{},renderProducts=()=>{},renderCustomerOrders=()=>{},openCart=()=>{},setModal=()=>{},startCheckout=()=>{},resetFilters=()=>{},navigateRoute=()=>{},closePaymentModal=()=>{},refreshPaymentStatus=()=>{},openQrisPayment=()=>{};
