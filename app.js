...
function renderShowcases() {
  ...
  $("smartphoneShowcase").innerHTML = phones.map(product => productCard(product, true)).join("");
  $("popularShowcase").innerHTML = popular.map(product => productCard(product, true)).join("");
}
